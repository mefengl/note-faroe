...
func CreateApp(env *Environment) http.Handler {
	...
	router.Handle("DELETE", "/users/:user_id/second-factors", handleDeleteUserSecondFactorsRequest)
	...
	router.Handle("POST", "/users/:user_id/register-totp-credential", handleRegisterUserTOTPCredentialRequest)
	router.Handle("GET", "/users/:user_id/totp-credentials", handleGetUserTOTPCredentialsRequest)
	router.Handle("DELETE", "/users/:user_id/totp-credentials", handleDeleteUserTOTPCredentialRequests)
	router.Handle("GET", "/totp-credentials/:credential_id", handleGetTOTPCredentialRequest)
	router.Handle("DELETE", "/totp-credentials/:credential_id", handleDeleteTOTPCredentialRequest)
	router.Handle("POST", "/totp-credentials/:credential_id/verify-totp", handleVerifyTOTPCredentialTOTPRequest)
